    ...
    return (
        <>
            <motion.section id='contact' ref={ref} initial="initial" whileInView="animate" className='md:snap-center h-screen w-full flex flex-col md:flex-row items-center md:divide-x divide-neutral-800 space-x-10 pt-[6rem]'>
                ...
                <div className="h-2/3 w-full md:w-1/2 flex justify-center items-center relative">
                    <motion.div className="absolute top-0 left-0 w-full h-full p-16 bg-purple-800/5 stroke-purple-600" initial={{ opacity: 1, zIndex: 3 }} whileInView={{ opacity: 0, zIndex: 0 }} transition={{ delay: 3, duration: 1 }}>
