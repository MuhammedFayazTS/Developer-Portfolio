...
function Modal({ data }) {
    ...
    return (
        <>
                        ...
                        >
                            <motion.div variants={variants} className="w-11/12 md:w-2/3 h-fit md:h-4/6 rounded-md bg-neutral-950 outline outline-1 outline-neutral-800 grid md:grid-cols-2 relative">
                                ...
                                <div className="pb-8 px-2 md:p-10 flex flex-col justify-between md:relative">
                                    ...
                                    <p className='md:text-justify text-lg md:text-xl  my-2'>{data.desc}</p>
                                    <div className="flex justify-center gap-x-5">
                                        <button className="border-none px-8 py-2 rounded-md bg-purple-500">Live</button>
                                        <button className="border-none px-8 py-2 rounded-md bg-purple-500">Code</button>
                                    </div>
                                </div>
                            </motion.div>
                        </motion.div>
            ...
            <button onClick={(e)=>setOpen(prev=>!prev)} className='w-28 py-1 flex justify-center items-center rounded outline outline-1 outline-purple-400 text-purple-400'>View</button>
        </>
    );
}
